...
function btnbarfix(temp1,temp2) {
	...
	tempcolor = rgbaToRgb(.73 - tempx, '0.15', temprgba, temprgb); // btnshade
	...
	document.body.style.setProperty('--btnshade4', getYIQ(temp1) > 127 ? 'rgba(32,32,32,0.1)' : 'rgba(208,208,208,0.2)');
